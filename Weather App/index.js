...
function display(data){
   ...
   $("#TempRange").text(temperature(data.main.temp_min)+"(min)/"+temperature(data.main.temp_max) + " (max)");
...
function climate_change(data)
{
    ...
    {
        var imgurl="images/clear_sky.jpg";
    }
    ...
    else if(main.toLowerCase ()== 'rain'){  var imgurl="images/rainy.jpg";}
